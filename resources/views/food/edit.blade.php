       ...
       <div class="col-md-8">
        ...
        <div class="card-body">
          ...
          <label for="description">Description</label>
          	<textarea cols="5" rows="8" name="description" class="form-control @error('description') is-invalid @enderror">
          		{{$food->description}}
          	</textarea> 
          ...
          <div class="form-group">
          	...
          	class="form-control @error('price') is-invalid @enderror" value="{{$food->price}}">
          	@error('price')
	            <span class="invalid-feedback" role="alert">
	                <strong>{{ $message }}</strong>
	            </span>
